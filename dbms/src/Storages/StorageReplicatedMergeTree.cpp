...
void StorageReplicatedMergeTree::getStatus(Status & res, bool with_zk_fields)
{
    ...
    res.last_successful_queue_update_attempt = last_successful_queue_update_attempt_time.load();
    res.last_queue_update_attempt = last_queue_update_attempt_time.load();
...
time_t StorageReplicatedMergeTree::getAbsoluteDelay() const
{
    ...
    min_unprocessed_insert_time = std::min(current_time, min_unprocessed_insert_time);
    ...
    else if (min_unprocessed_insert_time)
    {
        ...
        return current_time - min_unprocessed_insert_time;
    }
    else if (queue_update_time > successful_queue_update_time)
    {
        ...
        return current_time - queue_update_time;
    }
    else
    {
